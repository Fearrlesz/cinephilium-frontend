...
const criteriaNames = [
  ...
  ['2.1 Глубина личности', '2.2 Химия и Ансамбль', '2.3 Органика поведения', '2.4 Эволюция личности', '2.5 Сложность'],
  ['3.1 Композиция и Среда', '3.2 Движение камеры', '3.3 Цветовая партитура', '3.4 Монтажный ритм', '3.5 Визуальный символизм'],
  ['4.1 Музыкальная драматургия', '4.2 Тембр и Стиль', '4.3 Шумовая партитура', '4.4 Использование Тишины', '4.5 Техническая чистота']
];

const baseDescriptions = [
  [
    'Насколько органично события вытекают друг из друга?',
    'Есть ли внятное развитие: знакомство → кризис → кульминация?',
    'Ясны ли цели и мотивации героев?',
    'Насколько живые и многослойные диалоги?',
    'Дает ли фильм ценность зрителю?'
  ],
  [
    'Есть ли у героя слабости и внутренние конфликты?',
    'Есть ли химия между персонажами?',
    'Органично ли поведение героев?',
    'Развиваются ли персонажи в ходе сюжета?',
    'Не перегружен ли персонаж деталями?'
  ],
  [
    'Продумано ли расположение предметов в кадре?',
    'Уместно ли движение камеры и его смысл?',
    'Согласована ли цветовая палитра?',
    'Ритм монтажа создает ли напряжение/покой?',
    'Есть ли визуальные символы и работают ли они?'
  ],
  [
    'Помогает ли музыка передавать настроение?',
    'Совместим ли тембр с жанром?',
    'Работают ли шумы и звуковые слои?',
    'Используется ли тишина как выразительное средство?',
    'Нормальна ли техническая реализация звука?'
  ]
];
