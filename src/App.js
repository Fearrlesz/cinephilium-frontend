...
export const PRESET_WEIGHTS = {
  drama:        [25, 20, 20, 15, 20],  // было [25,20,20,15,20] – теперь сценарий и персонажи на первом плане
  action:       [20, 20, 30, 20, 10],  // без изменений – идеально для экшена
  comedy:       [30, 30, 15, 15, 10],  // без изменений – юмор и харизма решают всё
  horror:       [25, 20, 20, 25, 10],  // без изменений – звук и сюжет равнозначны
  scifi_block:  [25, 20, 25, 20, 10],  // без изменений – блокбастерная формула работает
  scifi_author: [25, 20, 20, 15, 20],  // было [20,20,25,15,20] – поднял сценарий (идеи), слегка опустил визуал
  musical:      [20, 20, 20, 30, 10],  // без изменений – музыка превыше всего
  biopic:       [30, 30, 20, 15, 5],   // без изменений – история и актёрская игра ключевые
  hybrid:       null
};
  ...
  <header className="section-header">
    ...
    <p>
      ...
      а в байопике сценарий и персонажи выходят на первый план. 
         Также любой, даже самый причудливый фильм, к примеру, «Андалузский пёс», может быть объективно оценён в своём жанре! Сценарий будет иметь второстепенное значение, что сосредоточит оценку на стиле и визуале, одно из главных преимуществ нашей системы.
    </p>
  </header>
